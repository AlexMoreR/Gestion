    ...
    <main className="flex flex-col gap-4">
          ...
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-center">
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                <h1 className="text-3xl font-extrabold tracking-tighter md:text-5xl">COTIZACIÓN</h1>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card className="border-slate-200/60 shadow-sm">
          ...
          <CardContent className="grid grid-cols-2 gap-4 text-sm">
            <div><p className="text-slate-400 flex items-center gap-1"><Calendar className="h-3 h-3" /> Emisión</p><p className="font-semibold">{issuedDate}</p></div>
            <div><p className="text-slate-400 flex items-center gap-1"><MapPin className="h-3 h-3" /> Origen</p><p className="font-semibold">{companyInfo.cityOrigin}</p></div>
            <div><p className="text-slate-400 flex items-center gap-1"><ShieldCheck className="h-3 h-3" /> Garantía</p><p className="font-semibold">{companyInfo.warranty}</p></div>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-3">
                        {item.product.thumbnailUrl && (
                          <img src={getPublicAssetUrl(item.product.thumbnailUrl)} alt={item.product.name} className="h-10 w-10 rounded-md object-cover border" />
                        )}
                        <p className="font-semibold text-slate-900">{item.product.name}</p>
                      </div>
                    </TableCell>
                    <TableCell className="hidden md:table-cell text-slate-500 max-w-[200px] truncate">{item.meta.description || "Ninguna observación"}</TableCell>
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="w-full md:w-80 space-y-2">
          ...
          <div className="flex justify-between rounded-xl bg-slate-900 p-4 text-white shadow-xl">
