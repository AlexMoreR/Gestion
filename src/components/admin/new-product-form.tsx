          ...
          <section className="space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <label className="block space-y-1.5 md:col-span-2">
                ...
                <div className="space-y-3 rounded-xl border border-dashed border-[var(--line-strong)] bg-slate-50/60 p-4">
                  <input
                    ref={fileInputRef}
                    name="images"
                    type="file"
                  ...
                  <button
                    type="button"
                    className={`flex w-full cursor-pointer flex-col items-center justify-center rounded-lg border px-4 py-8 text-center transition ${
                      dragActive
                  ...
                  <div className="flex items-center justify-end">
                    <span className="text-[11px] text-slate-500">
                      {allImageUrls.length} imagen(es) seleccionada(s)
                    </span>
                  </div>
                </div>
              </label>
